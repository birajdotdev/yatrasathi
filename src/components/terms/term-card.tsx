...
export default function TermCard({ term }: TermCardProps) {
  return (
    <div className="group rounded-xl border border-border/40 bg-card/30 p-6 shadow-sm transition-all duration-300 hover:border-primary/30 hover:bg-card/50 hover:shadow-md dark:border-border/40 dark:bg-background/30 dark:hover:border-primary/50 dark:hover:bg-background/50">
